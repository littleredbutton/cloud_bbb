OC.L10N.register(
    ...
    "Explanation of the different concepts that constitute access options :<br> - Public: Anyone who has the link can join.<br> - Internal: Only Nextcloud users can join.<br> - Password: Only guests who have the password can join.<br> - Waiting room: A moderator must accept each guest before they can join.<br> - Restricted : Only selected users and groups can access this room." : "Vysvětlení přístupových možností:<br> - Veřejné: Může se připojit kdokoliv, kdo má odkaz.<br> - Interní: Mohou se připojit pouze uživatelé Nextcloudu.<br> - Heslo: Mohou se připojit pouze hosté, kteří znají heslo.<br> - Předsíň / vyčkávací místnost: Moderátor musí přijmout každého hosta, až poté se mohou připojit.<br> - Omezené: Připojit se mohou pouze určití uživatelé a skupiny.",
