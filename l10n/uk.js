OC.L10N.register(
    "bbb",
    {
    "API url or secret not configured. Please contact your administrator." : "Посилання на API або пароль не налаштовано. Будь ласка, сконтактуйте з вашим адміністратором.",
    ...
    "Get your API url and secret by executing \"sudo bbb-conf --secret\" on your BigBlueButton server." : "Щоб отримати ваше посилання на API або пароль, будь ласка, виконайте \"sudo bbb-conf --secret\" на вашому сервері BigBlueButton.",
    "API url" : "Посилання на API",
    ...
    "API url is invalid" : "Неправильне посилання на API",
