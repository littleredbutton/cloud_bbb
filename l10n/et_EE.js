OC.L10N.register(
    ...
    "Save" : "Salvesta",
    "Use Nextcloud theme in BigBlueButton." : "Kasuta BigBlueButtoni puhul Nextcloudi kujundust.",
    ...
    "Community" : "Kogukond",
    "Are you enjoying this app? Give something back to the open source community." : "Kas see rakendus meeldib sulle? Võid avatud lähtekoodi põhjal arendavale kogukonnale ka midagi tagasi anda.",
    "Checkout the contributor guide" : "Vaata teavet kaasautorite juhendist",
    "URL Shortener" : "Võrguaadressi lühendusteenus",
    "If you like to use shorter urls, you can enter a forwarding proxy below." : "Kui sulle meeldivad lühemad võrguaadressid, võid edastava proksi sisestada alljärgnevalt.",
    "URL shortener" : "Võrguaadressi lühendusteenus",
    ...
    "URL has to contain the {token} placeholder" : "Võrguaadressis peab leiduma „{token}“ kohatäitja",
    "URL has to start with https:// and contain {token}. Additionally the {user} placeholder can be used." : "Võrguaadressi alguses peab olema https:// ja seal peab sisalduma „{token}“. Lisaks võid määratleda ka „{user}“ kohatäitja.",
