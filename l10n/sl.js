OC.L10N.register(
    "bbb",
    {
    "API url or secret not configured. Please contact your administrator." : "Naslov URL oziroma koda API ni nastavljena. Stopite v stik s skrbnikom sistema.",
    ...
    "Get your API url and secret by executing \"sudo bbb-conf --secret\" on your BigBlueButton server." : "Naslov API in kodo je mogoče pridobiti z ukazom »sudo bbb-conf --secret« na strežniku BigBlueButton.",
