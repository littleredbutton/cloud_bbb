OC.L10N.register(
    ...
    "Room URL was stored in \"{path}\" as \"{filename}\"." : "S'URL de s'istantza s'est sarvadu in \"{caminu}\" comente \"{nùmene documentu}\".",
    "Link stored" : "Ligòngiu sarvadu",
    "URL to room could not be stored." : "No at fatu a sarvare s'URL de s'istantza.",
    "Error" : "Errore",
    "URL to presentation was stored in \"{path}\" as \"{filename}\"." : "S'URL de sa presentatzione s'est sarvadu in \"{caminu}\" comente \"{nùmene documentu}\".",
