OC.L10N.register(
    ...
    "This app allows to create meetings with an external installation of [BigBlueButton](https://bigbluebutton.org).\n\n* **Room setup** Create multiple room configurations with name, welcome message, ...\n* **Share guest link** Share the room link with all your guests\n* **Custom presentation** Start a room with a selected presentation from your file browser\n* **Manage recordings** View, share and delete recordings for your rooms\n\nDeveloper wanted! If you have time it would be awesome if you could help to enhance this application.\n\n*This app integrates BigBlueButton and is not endorsed or certified by BigBlueButton Inc. BigBlueButton and the BigBlueButton Logo are trademarks of BigBlueButton Inc.*" : "このアプリは、[BigBlueButton](https://bigbluebutton.org)を外部インストールして会議を作成することができます。\n\n* **会議室の設定** 会議室の名前やウェルカムメッセージなどを入力して、複数の会議室の設定を行うことができます。\n* **ゲストリンクを共有** ゲスト全員と部屋のリンクを共有します。\n* **カスタムプレゼンテーション** ファイルブラウザから選択したプレゼンテーションで会議室を起動します。\n* **記録を管理** あなたの会議室記録を表示、共有、削除することができます。\n\n開発者募集! もし時間があれば、このアプリケーションを強化するのに協力してくれたら最高です。\n\n*このアプリはBigBlueButtonを統合したものであり、BigBlueButton Inc.の承認や認定を受けたものではありません。BigBlueButtonとBigBlueButtonロゴはBigBlueButton Inc.の商標です。",
    ...
    "Access" : "アクセス",
    "Public" : "公開",
    "Internal + Password protection for guests" : "内部 + ゲストへのパスワード保護",
    "Internal + Waiting room for guests" : "内部 + ゲストへの待合室",
    "Internal" : "内部",
    "Internal restricted" : "内部制限済み",
