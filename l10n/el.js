OC.L10N.register(
    ...
    "This app allows to create meetings with an external installation of [BigBlueButton](https://bigbluebutton.org).\n\n* **Room setup** Create multiple room configurations with name, welcome message …\n* **Share guest link** Share the room link with all your guests\n* **Share rooms** Share rooms with members, groups or circles\n* **Custom presentation** Start a room with a selected presentation from your file browser\n* **Manage recordings** View, share and delete recordings for your rooms\n* **Restrictions** Restrict room creation to certain groups\n* **Activities** Get an overview of your room activities\n\nDeveloper wanted! If you have time it would be awesome if you could help to enhance this application.\n\n*This app integrates BigBlueButton and is not endorsed or certified by BigBlueButton Inc. BigBlueButton and the BigBlueButton Logo are trademarks of BigBlueButton Inc.*" : "Αυτή η εφαρμογή επιτρέπει τη δημιουργία συναντήσεων με εξωτερική εγκατάσταση του [BigBlueButton] (https://bigbluebutton.org). *  ** Ρύθμιση δωματίου ** Δημιουργία πολλαπλών διαμορφώσεων δωματίου με όνομα, μήνυμα καλωσορίσματος… * ** Κοινή χρήση συνδέσμου επισκεπτών ** Κοινή χρήση του συνδέσμου δωματίου με όλους τους καλεσμένους σας * * ** Κοινή χρήση δωματίων ** Κοινή χρήση δωματίων με μέλη, ομάδες ή κύκλους * ** Προσαρμοσμένη παρουσίαση ** Ξεκινήστε μια αίθουσα με μια επιλεγμένη παρουσίαση από το πρόγραμμα περιήγησης αρχείων σας * ** Διαχείριση εγγραφών ** Προβολή, κοινή χρήση και διαγραφή εγγραφών για τα δωμάτιά σας * **\n* ** Περιορισμοί ** Περιορισμός δημιουργίας δωματίου σε συγκεκριμένες ομάδες ** Δραστηριότητες ** Λάβετε μια επισκόπηση των δραστηριοτήτων του δωματίου σας\n Ο προγραμματιστής ήθελε! Εάν έχετε χρόνο θα ήταν ωραίο αν θα μπορούσατε να βοηθηστε στη βελτίωση αυτής της εφαρμογής. \n\nΑυτή η εφαρμογή ενσωματώνει το BigBlueButton και δεν υποστηρίζεται ή πιστοποιείται από την BigBlueButton Inc. Το BigBlueButton και το λογότυπο BigBlueButton είναι εμπορικά σήματα της BigBlueButton Inc. *",
