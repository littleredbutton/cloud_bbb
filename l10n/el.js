OC.L10N.register(
    ...
    "An error occurred while sending the file to the room." : "Παρουσιάστηκε σφάλμα κατά την αποστολή του αρχείου στο δωμάτιο.",
    ...
    "Only rooms for which you are one of the administrators will be displayed." : "Θα εμφανίζονται μόνο τα δωμάτια για τα οποία είστε ένας από τους διαχειριστές.",
    "Send to" : "Αποστολή σε",
