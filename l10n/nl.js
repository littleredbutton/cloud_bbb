OC.L10N.register(
    ...
    "You started a meeting in the \"%s\" room." : "Je begon een bijeenkomst in ruimte \"%s\".",
    "{user} started a meeting in the \"%s\" room." : "{user} begon een bijeenkomst in ruimte \"%s\".",
    "The meeting in room \"%s\" has ended." : "De bijeenkomst in ruimte %s is beëindigd.",
