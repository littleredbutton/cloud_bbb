OC.L10N.register(
    ...
    "A moderator is able to manage all participants in a meeting including kicking, muting or selecting a presenter. Users with the role moderator are also able to close a meeting or change the default settings." : "Moderatör, atma, sessize alma veya sunucu olarak atama dahil olmak üzere tüm katılımcıları yönetebilir. Moderatör rolüne sahip kullanıcılar aynı zamanda toplantıyı bitirebilir veya varsayılan ayarlarını değiştirebilirler.",
    ...
    "Internal" : "İç",
    "Internal restricted" : "İç kullanıma kısıtlı",
    "Every participant is moderator" : "Tüm katılımcılar moderatördür",
    "Miscellaneous" : "Diğer",
    ...
    "Share" : "Paylaş",
    "Loading" : "Yükleniyor",
    "Name, group, ..." : "İsim, grup, ...",
    "You are not allowed to change this option, because this room is shared with you." : "Bu ayarı değiştiremezsiniz, çünkü bu oda sizinle paylaşıldı.",
