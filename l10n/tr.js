OC.L10N.register(
    ...
    "If enabled, the moderator is able to start the recording." : "Bu seçenek etkinse, sorumlu toplantıyı kaydedebilir.",
    ...
    "If enabled, normal users have to wait until a moderator is in the room." : "Bu seçenek etkinse, odaya bir sorumlu gelene kadar kullanıcıların beklemesi gerekir.",
    "If enabled, a moderator URL is generated which allows access with moderator permission." : "Bu seçenek etkinse, sorumlu yetkileri ile erişilebilecek bir sorumlu adresi oluşturulur.",
    ...
    "If enabled, the user has not to perform an echo call and webcam preview on the first join (available since BBB server 2.3)." : "Bu seçenek etkinse, kullanıcı ilk kez katılırken, bir yankı çağrısı ve bilgisayar kamerası ön izlemesi yapması gerekmez (BBB sunucu 2.3 sürümü ve üzeri için).",
    "If enabled, the user list, chat area and presentation are hidden by default." : "Bu seçenek etkinse, kullanıcı listesi, sohbet alanı ve sunum varsayılan olarak gizlenir.",
    "If enabled, all users will join the meeting muted." : "Bu seçenek etkinse, tüm kullanıcılar görüşmeye sesi kapalı olarak katılır.",
