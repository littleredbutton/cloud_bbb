OC.L10N.register(
    ...
    "This app allows to create meetings with an external installation of [BigBlueButton](https://bigbluebutton.org).\n\n* **Room setup** Create multiple room configurations with name, welcome message …\n* **Share guest link** Share the room link with all your guests\n* **Share moderator link** Invite moderators to the room\n* **Share rooms** Share rooms with members, groups or circles\n* **Custom presentation** Start a room with a selected presentation from your file browser\n* **Manage recordings** View, share and delete recordings for your rooms\n* **Restrictions** Restrict room creation to certain groups\n* **Activities** Get an overview of your room activities\n\nQuick start guide and further information in our [readme](https://github.com/littleredbutton/cloud_bbb).\nDo you like this application? Give something back to the open source community and checkout our\n[ways to contribute](https://github.com/littleredbutton/cloud_bbb/blob/master/.github/contributing.md).\n\nContributors are welcome! If you have time it would be awesome if you could help to enhance this application.\n\n*This app integrates BigBlueButton and is not endorsed or certified by BigBlueButton Inc. BigBlueButton and the BigBlueButton Logo are trademarks of BigBlueButton Inc.*" : "Это приложение позволяет создавать встречи с внешней установкой [BigBlueButton](https://bigbluebutton.org).\n\n* **Настройка комнат** Создайте несколько конфигураций комнат с именем и приветственным сообщением …\n* **Поделитесь ссылкой для гостя** Поделитесь ссылкой на комнату со всеми гостями\n* **Поделитесь модераторской ссылкой** Пригласите модераторов в комнату\n* **Делитесь комнатами** Делитесь комнатами с участниками, группами или кругами.\n* **Пользовательская презентация** Начните комнату с выбранной презентацией в браузере файлов.\n* **Управление записями** Просматривайте, делитесь и удаляйте записи для своих комнат.\n* **Ограничения** Ограничить создание комнат определенными группами.\n* **Действия** Получите обзор действий в вашей комнате.\n\nКраткое руководство и дополнительная информация в нашем [readme](https://github.com/littleredbutton/cloud_bbb).\nВам нравится это приложение? Верните что-нибудь взамен сообществу открытого исходного кода и ознакомьтесь с нашими\n[способами контрибуции](https://github.com/littleredbutton/cloud_bbb/blob/master/.github/contributing.md).\n\nАвторы приветствуются! Если у вас есть время, было бы здорово, если бы вы помогли улучшить это приложение.\n\n*Это приложение интегрируется с BigBlueButton, но не одобрено и не сертифицировано BigBlueButton Inc. BigBlueButton и BigBlueButton Logo - торговые марки BigBlueButton Inc.*",
    "Send to BBB" : "Отправить в BBB",
    "An error occurred while sending the file to the room." : "Произошла ошибка при отправке файла в комнату.",
    "Loading…" : "Загрузка…",
    ...
    "Only rooms for which you are one of the administrators will be displayed." : "Будут отображаться только комнаты, администратором которых вы являетесь.",
    "Send to" : "Отправить в",
    ...
    "Explanation of the different concepts that constitute access options :<br> - Public: Anyone who has the link can join.<br> - Internal: Only Nextcloud users can join.<br> - Password: Only guests who have the password can join.<br> - Waiting room: A moderator must accept each guest before they can join.<br> - Restricted : Only selected users and groups can access this room." : "Объяснение различных понятий, составляющих варианты доступа: <br> - Открытый: присоединиться может любой, у кого есть ссылка. <br> - Внутренний: присоединиться могут только пользователи Nextcloud. <br> - Пароль: присоединиться могут только гости, у которых есть пароль. <br> - Зал ожидания: модератор должен принять каждого гостя, прежде чем он сможет присоединиться. <br> - Ограничено: только выбранные пользователи и группы могут получить доступ к этой комнате.",
    ...
    "Access options" : "Настройки доступа",
    ...
    "Example configuration for Apache and Nginx" : "Пример конфигурации для Apache и Nginx",
