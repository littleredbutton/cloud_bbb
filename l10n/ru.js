OC.L10N.register(
    "bbb",
    {
    "API url or secret not configured. Please contact your administrator." : "API url или секрет не сконфигурированы. Пожалуйста, свяжитесь с вашим администратором. ",
    ...
    "Get your API url and secret by executing \"sudo bbb-conf --secret\" on your BigBlueButton server." : "Получите ваш API url и секрет выполнив команду \"sudo bbb-conf --secret\" на вашемr BigBlueButton сервере.",
    "API url" : "API url",
    ...
    "API url is invalid" : "API url недействительна",
